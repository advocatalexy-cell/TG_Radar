...
- ЗАПРЕЩЕНО обрезать `summary` по числу слов/символов — это обрывает предложение на середине. Если `summary` длиннее ~12 слов, перепиши его короче целиком, сохранив смысл и грамматическую законченность, а не отрежь хвост
